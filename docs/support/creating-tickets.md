...
The ticket is created with status **Open** and priority **Normal**. Both you and the support team receive an email notification.

## Attaching Screenshots

You can attach images to help illustrate your issue. Click **Attach screenshot** below the message field, or drag and drop files onto the button.
...
1. Click on a ticket in the left panel to open it.
2. Type your reply in the text area at the bottom.
3. Optionally attach more screenshots.
4. Click **Send** (or press `Cmd+Enter` / `Ctrl+Enter`).

You can add replies to any ticket that is not **Closed**.
