...
<a href="https://app.gitbook.com/s/xKzkxBScfGXAbqoqyEbd/getting-started" class="button primary" data-icon="rocket-launch">Quick Start</a><a href="https://app.collieai.io" class="button primary" data-icon="right-to-bracket">Try for Free</a><a href="https://app.gitbook.com/s/xKzkxBScfGXAbqoqyEbd/api-reference" class="button secondary">API Reference</a>
...
<table data-view="cards"><thead><tr><th></th><th></th><th></th></tr></thead><tbody><tr><td><h4><i class="fa-rocket-launch" style="color:$primary;">:rocket-launch:</i></h4></td><td><h3><a href="https://app.gitbook.com/s/xKzkxBScfGXAbqoqyEbd/getting-started">Getting started</a></h3></td><td>Sign up, create a project, send your first secured request</td></tr><tr><td><h4><i class="fa-plug-circle-plus" style="color:$primary;">:plug-circle-plus:</i></h4></td><td><h3><a href="https://app.gitbook.com/s/xKzkxBScfGXAbqoqyEbd/proxy-integration">Proxy Integration</a></h3></td><td>Connect the OpenAI SDK, streaming, and error handling</td></tr><tr><td><h4><i class="fa-arrows-retweet" style="color:$primary;">:arrows-retweet:</i></h4></td><td><h3><a href="https://app.gitbook.com/s/xKzkxBScfGXAbqoqyEbd/async-jobs">Async Jobs</a></h3></td><td>Submit requests and receive results via webhooks</td></tr></tbody></table>

## Explore

<table data-view="cards"><thead><tr><th></th><th></th><th></th></tr></thead><tbody><tr><td><h4><i class="fa-square-a-lock" style="color:$primary;">:square-a-lock:</i></h4></td><td><h3><a href="https://app.gitbook.com/s/xKzkxBScfGXAbqoqyEbd/security-rules">Security Rules</a></h3></td><td>Configure PII masking, threat blocking, and text processing</td></tr><tr><td><h4><i class="fa-diagram-subtask" style="color:$primary;">:diagram-subtask:</i></h4></td><td><h3><a href="https://app.gitbook.com/s/xKzkxBScfGXAbqoqyEbd/projects-and-policies">Projects &#x26; Policies</a></h3></td><td>Organize workloads with projects, policies, and provider tokens</td></tr><tr><td><h4><i class="fa-display-chart-up-circle-currency" style="color:$primary;">:display-chart-up-circle-currency:</i></h4></td><td><h3><a href="https://app.gitbook.com/s/xKzkxBScfGXAbqoqyEbd/monitoring">Monitoring</a></h3></td><td>Submit requests and receive results via webhooks</td></tr></tbody></table>
